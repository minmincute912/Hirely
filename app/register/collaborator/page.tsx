...
import { User, Mail, Phone, Lock, Eye, EyeOff, Briefcase, ArrowLeft } from "lucide-react"
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Card className="bg-white/10 backdrop-blur-xl border-white/20 shadow-2xl">
          <CardHeader className="text-center pb-2">
            <div className="w-16 h-16 bg-gradient-to-r from-red-500 to-pink-500 rounded-xl mx-auto mb-4 flex items-center justify-center">
              <Briefcase className="w-8 h-8 text-white" />
            </div>
            <h1 className="text-2xl font-bold text-white">Become HR Partner</h1>
            <p className="text-gray-300">Join our recruitment network</p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-12 h-12 bg-white/10 border-white/20 text-white placeholder:text-gray-400 focus:border-red-400 focus:ring-red-400/20"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-200">Specialization</label>
                <div className="relative">
                  ...
                  <Select value={formData.field} onValueChange={(value) => setFormData({ ...formData, field: value })}>
                    <SelectTrigger className="pl-12 h-12 bg-white/10 border-white/20 text-white focus:border-red-400 focus:ring-red-400/20">
                    ...
                    <SelectContent className="bg-slate-800 border-slate-700">
                      ...
                      <SelectItem value="recruitment-process">Recruitment Process</SelectItem>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-12 pr-12 h-12 bg-white/10 border-white/20 text-white placeholder:text-gray-400 focus:border-red-400 focus:ring-red-400/20"
                  />
                  <button
                    type="button"
            ...
            <div className="space-y-4">
              ...
              <Button className="w-full h-12 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white font-medium transition-all duration-200">
                Join as HR Partner
              </Button>
            </div>
